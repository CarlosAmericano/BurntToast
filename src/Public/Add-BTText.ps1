function Add-BTText {
    <#
        ...
        The PassThru parameter is used to pass the toast content builder down the pipeline. Note that this isn't required at the end of the pipeline as the stored object has already been updated.
